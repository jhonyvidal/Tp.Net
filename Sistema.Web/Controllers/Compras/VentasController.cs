    ...
    public class VentasController : ControllerBase
    {
        ...
        public async Task<IEnumerable<VentaViewModel>> Listar()
        {
            ...
            return venta.Select(v => new VentaViewModel
            {
                ...
                cliente = v.categoria.nombre_empleado,
                //num_documento=v.categoria.id_empleado,
                direccion=v.categoria.direccion,
                telefono=v.categoria.telefono_fijo,
                email=v.categoria.correo,
                idusuario = v.idusuario,
                usuario = v.usuario.categoria.nombre_empleado,
